      ...
      <div class="container mx-auto px-6 py-16 text-center">
        <div class="mx-auto max-w-lg">
          <h1 class="text-3xl font-bold text-gray-800  dark:text-white lg:text-4xl ">
            ...
            <span className="text-green-600 text-justify"> LA MOBILITÉ AUTOMOBILE</span>
          </h1>
          <p class="mt-6 text-gray-500 dark:text-gray-300">
            Nous concilions mobilité humaine infinie et préservation de
            l'environnement à grande échelle grâce à l'hydrogène vert.
            Egalement, le zéro émission.
          </p>
        </div>

        <div class="mt-10 flex justify-center">
          <img
            class="h-[600px] w-full rounded-xl object-cover lg:w-4/5"
            src="https://www.namx-hydrogen.com/img/home/namx-ban-1024w.webp"
          />
        </div>
      </div>
              ...
              <div class="mx-auto max-w-md px-4 text-center sm:max-w-2xl sm:px-6 lg:flex lg:items-center lg:px-0 ">
                ...
                <h1 class="mt-4 text-4xl font-bold tracking-tight text-black sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl"><span class="block text-black">CAPSULE</span><span class="block text-green-600"> HYDROGÈNE </span></h1>
                  ...
                  <p class="mt-3 text-base text-gray-400 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                    Afin de réduire les contraintes liées aux déplacements
                    décarbonés comme le temps de recharge, l'immobilisation et
                    la proximité des stations, nous proposons une formule
                    spéciale au-delà du NamX. Un système de livraison à domicile
                    par abonnement devrait voir le jour et les capsules
