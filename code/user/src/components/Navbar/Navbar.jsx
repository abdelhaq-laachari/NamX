...
<div className="flex justify-between items-center py-6 px-10 container mx-auto">
  ...
  <div>
    <h1 className="text-2xl font-bold bg-gradient-to-tr from-indigo-600 to-green-600 bg-clip-text text-transparent hover:cursor-pointer">N A M X</h1>
  </div>
  ...
  <div>
    ...
    <div className="flex items-center">
      ...
      <ul className="sm:flex space-x-4 hidden items-center">
        <li><a href="/" className="text-gray-300 hover:text-indigo-600 text-md ">Accueil</a></li>
